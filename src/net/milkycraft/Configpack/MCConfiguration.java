...
public class MCConfiguration extends org.bukkit.configuration.file.YamlConfiguration {
	...
	public MCConfiguration(Plugin plugin){
		this("config.yml", plugin);
	}
	public MCConfiguration(String file, Plugin plugin){
	...
	public MCConfiguration(File file, Plugin plugin){
		this.file = file;
		this.plugin = plugin;
		options = new MCConfigurationOptions(this);
		load();
	}
	...
	@Override
	public MCConfigurationOptions options(){
		return (MCConfigurationOptions) options;
	}
